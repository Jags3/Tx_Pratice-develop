...
public class MobileKeywords {
    ...
    public static void scrollAndClick(String data) {
        try {
            GlobalUtil.getMDriver().findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()" +
    ...
    public static void scrollAndFind(String data) {
        try {
            Assert.assertTrue(GlobalUtil.getMDriver().findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()" +
                    ".scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"" + data +
    ...
    public static void scrollAndVerify(String data) {
        try {
            Assert.assertEquals(GlobalUtil.getMDriver().findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()" + ".scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"" + data + "\").instance(0))").getText(), data);
    ...
    public static void findAndVerifyElement(By locator, int number, String logstep) {
        List<MobileElement> elements = (List<MobileElement>) GlobalUtil.getMDriver().findElements(locator);
        try {
            for (int i = 0; i <= elements.size() - 1; i++) {
                scrollAndFind(Constants.FIRST_NAME + " " + Constants.LAST_NAME);
            }
        } catch (Throwable t) {
            LogUtil.infoLog(thisClass, logstep + " could not be located ");
        }
    ...
    public static void isMobileKeypadVisible() {
        try {
            Assert.assertTrue(GlobalUtil.getMDriver().isKeyboardShown());
