...
public class CommonSettings {
	...
	private String androidVersion;  //Double
	 ...
	 */
	public String getAndroidVersion() {  //Double
	 ...
	 */
	public void setAndroidVersion(String androidVersion) {    //Double androidVersion
